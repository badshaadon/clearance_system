  ...
  <div style="background-image: url('../../image/winter.jpg'); background-repeat: no-repeat; background-size: cover; border: 5px solid gray; border: 5px solid gray;">
    <?php include "../../navbar.php";
      ...
      if((isset($_POST['feedback'])) && (mysqli_num_rows($result) == 0)) {
        ...
        $query    = "INSERT into `feedback` (username, account) VALUES ('$user_name' ,'$fback')";
        ...
        if ($result) {
          ...
          $sql = "UPDATE `feedback` SET `account` = '$fback' WHERE `username` = '$uname'";
      ...
      ?>
      <form action='user_feedback.php' method='post' class="w-75 mx-auto text-warning container pb-4">
        <div class="row">
