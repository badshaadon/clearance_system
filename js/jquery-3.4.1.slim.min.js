/*! jQuery v3.4.1 -ajax,-ajax/jsonp,-ajax/load,-ajax/parseXML,-ajax/script,-ajax/var/location,-ajax/var/nonce,-ajax/var/rquery,-ajax/xhr,-manipulation/_evalUrl,-event/ajax,-effects,-effects  ween,-effects/animatedSelector | (c) JS Foundation and other contributors | jquery.org/license */
!(function (e, t) {
  "use strict";
  ...
  var f =
      "3.4.1 -ajax,-ajax/jsonp,-ajax/load,-ajax/parseXML,-ajax/script,-ajax/var/location,-ajax/var/nonce,-ajax/var/rquery,-ajax/xhr,-manipulation/_evalUrl,-event/ajax,-effects,-effects  ween,-effects/animatedSelector",
    E = function (e, t) {
  ...
  var fe = /^(?:checkbox|radio)$/i,
    ...
    he = {
      ...
      td: [
        3,
        "<table><tbody><tr class='text-warning font-weight-bold display-4'>",
        "</tr></tbody></table>",
      ],
      _default: [0, "", ""],
    };
